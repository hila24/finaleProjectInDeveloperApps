...
19 בדיקות יחידה על הלוגיקה שקשה לתפוס בעין — חישוב הסקר (מנצחת, אחוזים, ממוצע דירוג,
...
`PollTest.kt` מכיל 14 בדיקות ו‑`DeadlinesTest.kt` עוד 5. נבחרה דווקא הלוגיקה הזו כי
